...
correlations_finance = EDA_Visualiser()
correlations_finance.correlation_heatmap(data= dataset_2.data_income, columns= ['N_Inhabitants', 'Tot_taxable_income', 'Mean_income_taxunit',
       'Median_income_taxunit', 'Mean_income_inhabitant', 'Wealth_index',
       'State_tax', 'Local_tax', 'Tot_tax', 'Price'])
       
correlations_property = EDA_Visualiser()
correlations_property.correlation_heatmap(data= dataset_2.data_income, columns= ['Garden area',
       'Surface of the land', 'Surface area of the plot of land', 'Price',
